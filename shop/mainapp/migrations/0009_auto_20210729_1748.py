# Generated by Django 3.2.4 on 2021-07-29 17:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0008_auto_20210726_1821'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('in_progres', 'Заказ в обработке'), ('is_ready', 'Заказ готов'), ('completed', 'Заказ выполнен')], default='new', max_length=100, verbose_name='Статус заказа')),
